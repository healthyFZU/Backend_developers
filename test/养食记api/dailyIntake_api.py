...
@app.route('/user/<int:userId>/intake', methods=['POST'])
...
@app.route('/user/<int:userId>/intake/<int:intakeId>', methods=['GET'])
...
@app.route('/user/<int:userId>/intake/<int:intakeId>', methods=['PUT'])
...
@app.route('/user/<int:userId>/intake/<int:intakeId>', methods=['DELETE'])
...
@app.route('/user/<int:userId>/intake/date/<date>', methods=['GET'])
