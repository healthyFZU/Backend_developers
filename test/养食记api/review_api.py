...
@app.route('/user/<int:userId>/review', methods=['POST'])
...
@app.route('/user/<int:userId>/review/<int:reviewId>', methods=['GET'])
...
@app.route('/user/<int:userId>/review/<int:reviewId>', methods=['PUT'])
...
@app.route('/user/<int:userId>/review/<int:reviewId>', methods=['DELETE'])
...
@app.route('/dish/<int:dishId>/reviews', methods=['GET'])
